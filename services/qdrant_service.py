...
class VectorStoreService:
    ...
    def _ensure_collection(self):
        ...
        if not self.client.collection_exists(self.collection_name):
            ...
            # Create Payload Indexes for tenant_id, src_file, role_user fields 
            try:
                ...
                self.client.create_payload_index(self.collection_name, "access_role", models.PayloadSchemaType.INTEGER)
            except Exception:
                pass
    ...
    # Delete document by tenant_id and src_file
            ...
            try:
                ...
                for j, chunk in enumerate(batch_chunks):
                    payload = {            
                        ...
                        "access_role": chunk.get("access_role"),              
    ...
    def search_hybrid(self, query: str, tenant_id: str, access_role: int, k: int = 10, top_k: Optional[int] = None):
        if top_k is not None:
            k = top_k
        
        # Tạo Vector embedding cho Input Query
        ...
        filter_condition = models.Filter(
            must=[
                ...
                models.FieldCondition(
                    key="access_role", 
                    match=models.MatchValue(value=access_role)
                )
            ]
        )
